...
\begin{figure}[H]
  \makebox[\textwidth][c]{\includegraphics[width=1.1\linewidth]{character_table.png}}
...
\begin{figure}[H]
  \makebox[\textwidth][c]{\includegraphics[width=1.1\linewidth]{perfect_phylogeny_table.png}}
  \caption{Albero di output del nostro script}
  \label{fig:script-tree}
\end{figure}
