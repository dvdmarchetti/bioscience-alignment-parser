...
\begin{figure}[H]
  \makebox[\textwidth][c]{\includegraphics[width=0.6\linewidth]{plot-alteration-in-cds.png}}
...
\begin{figure}[]
  \makebox[\textwidth][c]{\includegraphics[width=0.8\linewidth]{plot-variations-per-gene.png}}
  \caption{Percentuale di variazioni per gene}
  \label{fig:plot-alterations-per-gene}
\end{figure}

\begin{figure}[H]
  \makebox[\textwidth][c]{\includegraphics[width=0.8\linewidth]{plot-alteration-in-gene-per-sequence.png}}
